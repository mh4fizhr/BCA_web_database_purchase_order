...
<div class="header bg-primary pb-6">
    ...
    <div class="container-fluid mt--6">
      <section class="content">
        <div class="row">
          <div class="col-12">
            <form action="{{url('/backend/driver/edit/cutoff/proses')}}" method="post" role="form" id="dynamic_form">
              {{ csrf_field() }}
                <div class="card mb-4">
                  <!-- Card header -->
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <input type="hidden" name="po_id" value="{{$po->id}}"> 
                              ...
                              <div class="col-md-9">
                                <div class="form-group">
                                  <input class="form-control date" type="text" name="selesai" value="{{$po->Tgl_cutoff_driver}}" id="mulaisewa" placeholder="mm / dd / yyyy" required>
                                </div>
                              </div>
