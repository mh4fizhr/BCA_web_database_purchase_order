                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body p-5">
                    ...
                    <p>
                      ...
                      , dengan ini kami sampaikan penghentian sewa mobil sebanyak <b>{{$count_mobil}} ({{terbilang($count_mobil)}})</b> unit dan pengemudi sebanyak <b>{{$count_driver}} ({{terbilang($count_driver)}})</b> orang, dengan data sebagai berikut :
                    </p>
                    <br>
                    ...
                    <table class="table align-items-center table-flush table-hover text-center " id="myTable" style="width: 100%">
                      <thead class="">
                        <tr>
                          ...
                          <th scope="col" class="" style="min-width: 250px"><b>Pengurangan</b></th>
                        </tr>
                      </thead>
                      <tbody>
                         <?php $i = 0; ?>
                         ...
                         <form action="{{url('/backend/po/edit_pengurangan/multiple/'.$po->id)}}" method="post" role="form">
                           ...
                           <input type="hidden"                           name="sewa_template" value="{{$po_sewa}}">
                           ...
                           <!-- <input type="hidden" id="mobil_hasil{{$i}}"    name="jml_mobil" >
                           <input type="hidden" id="driver_hasil{{$i}}"   name="jml_driver" > -->
                           <input type="hidden" id="perihal{{$i}}" name="perihal" value="">
...
<!--                            <input type="hidden" id="mobil_hasil{{$i}}"    name="count_mobil" >
                           <input type="hidden" id="driver_hasil{{$i}}"   name="count_driver" > -->
                           ...
                           <tr>
                             ...
                             <td>
                               ...
                               <input type="hidden" name="sewa[]" id="sewa{{$i}}" value="{{$po->Sewa_sementara}}">
                               @if($po->Sewa_sementara == "Mobil+Driver")
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="form-group float-right pull-right">
                        <a href="{{url('backend/po/pengurangan')}}" type="button" class="btn btn-default">Back</a>
      ...
      while ( ++i < baris ) {
         ...
         (function(i){
            ...
            $('#cabang'+i).on('change', function(e) {
                ...
                //    $('#driver_hasil'+i).val(count_driver);
                //    $('#mobil_hasil'+i).val(count_mobil);
