              ...
              <div class="card-header border-0">
                ...
                <div class="dropdown float-right">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{url('/backend/admin/jabatan')}}">All</a>
                    <a class="dropdown-item" href="{{url('/backend/admin/jabatan/active')}}">Active</a>
                    <a class="dropdown-item" href="{{url('/backend/admin/jabatan/deactive')}}">Deactive</a>
                  </div>
                </div>
              </div>
                  ...
                  <div class="table-responsive">
                    <form action="{{url('backend/admin/jabatan/delete')}}" method="post" role="form">
                        {{ csrf_field() }}
...
<!--                                   <a class="btn btn-primary btn-sm" href="#">
                              ...
                              <td>
                                  <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="jabatan[]" id="customCheck{{$i}}" value="{{$jabatan->id}}">
