      ...
      <div class="container pl-5 pr-5">
        ...
        <div class="tab-content mb-5" id="myTabContent">
            <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                <form action="{{url('/backend/pejabat/unitkerja/add')}}" method="post" role="form">
                  {{ csrf_field() }}
                  <div class="card-body">
                    <!-- <p class="text-center text-danger">*Masukkan data <?php echo $page2 ?> sesuai petunjuk yang ada di form</p>
                    <br> -->
                    <h4 class="text-center" id="error_unitkerja"></h4>
                    <div class="row form-group">
                      <div class="col-md-12">
                        <label for="exampleInputtext1">Unit kerja</label>
                        <input type="text" name="unitkerja" class="form-control" id="unitkerja" placeholder="" required>
