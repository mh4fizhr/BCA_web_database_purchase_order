          ...
          <div class="col-12">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body p-5">
                    <p>
                      <span>No. <input class="form-control form-control-sm" type="text" id="no_surat" value="{{$template_perubahan->no_surat}}" required autocomplete="off" style="width: 250px;display: inline;"></span> 
                      
                      <span class="float-right">Jakarta, {{strftime("%d %B %Y", strtotime($template_perubahan->created_at))}}</span>
                    </p>
                    <br>
                    <p>
                      Kepada,
                    ...
                    <p>
                      ...
                      Menunjuk 
                      <input type="text" class="form-control form-control-sm" list="pks" id="pks" value="{{$template_perubahan->pks}}" placeholder="PKS / Addendum PKS" required autocomplete="off" style="width: 180px;display: inline;">
                      <!-- <datalist id="pks">
                        @foreach($jabatans as $jabatan)
                          <option>{{$jabatan->jabatan}}</option>
                        @endforeach
                      ...
                      No. 
                      <input type="text" class="form-control form-control-sm" list="no_pks" id="no_pks" value="{{$template_perubahan->no_pks}}" placeholder="nomor PKS / Addendum PKS" required autocomplete="off" style="width: 180px;display: inline;">
                      <!-- <datalist id="no_pks">
                        @foreach($jabatans as $jabatan)
                          <option>{{$jabatan->jabatan}}</option>
                        @endforeach
                      ...
                      tanggal 
                      <input class="form-control form-control-sm date" type="text" name="tgl_pks" value="{{$template_perubahan->tgl_pks}}" id="tgl_pks" placeholder="tanggal PKS / Addendum PKS" required style="width: 180px;display: inline;">
                           ...
                           <tr>
                             ...
                             <td>
                               @if($po->Cabang_relokasi == '')
                                 @foreach($cabangs as $cabang)
                                   @if($cabang->id == $po->Cabang_id)
                                      <span class="">{{$cabang->NamaCabang}}</span> 
                                   @endif
                                 @endforeach
                               @else
                                 @foreach($cabangs as $cabang)
                             ...
                             <td>
                               @if($table_template_perubahan->data_pairing_lama == "Mobil+Driver")
                                <span>Mobil+Driver</span>
                               @elseif($table_template_perubahan->data_pairing_lama == "Mobil")
                                <span>Mobil</span>
                               @endif
                             </td>
                             ...
                             <td>
                               <select class="form-control" id="sewa{{$i}}" name="sewa[]"  style="width: 200px;display: inline;">
                                 ...
                                 @if($table_template_perubahan->data_pairing_lama == "Mobil+Driver")
                                   <option value="Mobil" {{ $table_template_perubahan->data_pairing_baru == 'Mobil' ? 'selected' : '' }}>Mobil</option>
                                 @elseif($table_template_perubahan->data_pairing_lama == "Driver")
                                   
                                 @elseif($table_template_perubahan->data_pairing_lama == "Mobil")
                                 <option value="Mobil+Driver" {{ $table_template_perubahan->data_pairing_baru == 'Mobil+Driver' ? 'selected' : '' }}>Mobil+Driver</option>
                             ...
                             <td>
                               <input class="form-control date" type="text" placeholder="mm / dd / yyyy" name="tgl_efektif[]" value="{{$table_template_perubahan->tgl_efektif}}" id="example-date-input" autocomplete="off">
                             </td>
                    ...
                    <p>
                      ...
                      <select class="form-control form-control-sm" id="pb1" style="width: 300px;display: inline;">
                        ...
                        @foreach($pejabats as $pejabat)
                          @if($pejabat->active != '1')  
                            <option value="{{ $pejabat->id }}" {{ $pejabat->nama == $template_perubahan->nama_pb1 ? 'selected' : '' }}>{{$pejabat->nama}} - {{$pejabat->jabatan_id}} - {{$pejabat->unitkerja_id}}</option>
                          @endif
                        @endforeach
                      </select>
                      &nbsp | &nbsp
                      <select class="form-control form-control-sm"  id="pb2" style="width: 300px;display: inline;">
                        ...
                        @foreach($pejabats as $pejabat)
                          @if($pejabat->active != '1')  
                            <option value="{{ $pejabat->id }}" {{ $pejabat->nama == $template_perubahan->nama_pb2 ? 'selected' : '' }}>{{$pejabat->nama}} - {{$pejabat->jabatan_id}} - {{$pejabat->unitkerja_id}}</option>
                          @endif
                        @endforeach
                      </select>
<!--                       <br>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="form-group float-right pull-right">
                        <a href="{{url('backend/po/table/4')}}" type="button" class="btn btn-default">Back</a>
