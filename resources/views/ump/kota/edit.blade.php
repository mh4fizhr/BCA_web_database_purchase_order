...
<div class="header bg-primary pb-6">
    ...
    <div class="container-fluid mt--6">
      <section class="content">
        <div class="row">
          <div class="col-12">
            <form action="{{url('/backend/ump/kota/edit/proses/'.$kota->id)}}" method="post" role="form" id="dynamic_form">
              {{ csrf_field() }}
                <div class="card mb-4">
                  <!-- Card header -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="kota" id="kota" class="form-control" value="{{$kota->Kota}}" id="exampleInputtext1" required>
