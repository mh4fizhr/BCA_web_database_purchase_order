              ...
              <div class="card-header border-0">
                <h3 class="mb-0 text-uppercase d-inline-block"><li class="fa fa-database"></li> &nbspDatabase {{$page2}}</h3>
                  ...
                  <div class="table-responsive">
                    <form action="{{url('backend/admin/surat/perubahan/delete')}}" method="post" role="form">
                        {{ csrf_field() }}
                    <table class="table align-items-center table-flush table-hover mydatatable text-center" id="serve">
                          ...
                          <tbody>
                            ...
                            @if($template_perubahan->active != '1')
                            ...
                            @endif
                              ...
                              <td>
                                  <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="perubahan[]" id="customCheck{{$i}}" value="{{$template_perubahan->id}}">
