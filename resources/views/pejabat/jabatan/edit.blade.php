...
<div class="header bg-primary pb-6">
    ...
    <div class="container-fluid mt--6">
      <section class="content">
        <div class="row">
          <div class="col-12">
            <form action="{{url('/backend/pejabat/jabatan/edit/proses/'.$jabatan->id)}}" method="post" role="form" id="dynamic_form">
              {{ csrf_field() }}
                <div class="card mb-4">
                  <!-- Card header -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="jabatan" id="jabatan" class="form-control" value="{{$jabatan->jabatan}}" id="exampleInputtext1" required>
                                  <span id="error_jabatan"></span>
                                </div>
                          </div>                       
