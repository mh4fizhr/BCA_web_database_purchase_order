    ...
    <div class="container">
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a href="{{url('/backend/po/table')}}" class="nav-link">
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="{{url('/backend/cabang')}}" target="_blank" data-toggle="tooltip" data-original-title="DB cabang">
              <i class="fa fa-building"></i>
              <span class="nav-link-inner--text d-lg-none">Cabang</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="{{url('/backend/mobil')}}" target="_blank" data-toggle="tooltip" data-original-title="DB mobil">
              <i class="fa fa-car"></i>
              <span class="nav-link-inner--text d-lg-none">Mobil</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="{{url('/backend/ump/harga_ump')}}" target="_blank" data-toggle="tooltip" data-original-title="DB harga ump">
              <i class="fas fa-money-bill-wave"></i>
              <span class="nav-link-inner--text d-lg-none">Harga ump</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="{{url('/backend/vendor')}}" target="_blank" data-toggle="tooltip" data-original-title="DB vendor">
              <i class="ni ni-building"></i>
              <span class="nav-link-inner--text d-lg-none">Vendor</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="{{url('/backend/pejabat')}}" target="_blank" data-toggle="tooltip" data-original-title="DB pejabat">
              <i class="fas fa-user-tie"></i>
              <span class="nav-link-inner--text d-lg-none">Pejabat</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="{{url('/backend/pks')}}" target="_blank" data-toggle="tooltip" data-original-title="DB pks">
              <i class="fas fa-file-powerpoint"></i>
              <span class="nav-link-inner--text d-lg-none">PKS</span>
            </a>
          </li>
    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0" style="margin-top: -20px">
              ...
              <form method="POST" action="{{ route('login') }}" class="login100-form validate-form">
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="email" name="name" type="text">
                  </div>
                </div>
