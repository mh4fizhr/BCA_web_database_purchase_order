        ...
        <div class="row">
          <div class="col-12">
            <div class="card pb-4">
              <div class="card-header border-0">
                ...
                <div class="dropdown float-right">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{url('/backend/mobil/tahun/active')}}">Active</a>
                    <a class="dropdown-item" href="{{url('/backend/mobil/tahun/deactive')}}">Deactive</a>
                  </div>
                </div>
              </div>
              ...
              @if($s == 'active')     
                <div class="">
                  <form action="{{url('/backend/mobil/tahun/delete_multiple')}}" method="post" role="form">
                  {{ csrf_field() }}
                  <!-- Projects table -->
