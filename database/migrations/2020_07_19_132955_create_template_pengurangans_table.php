...
class CreateTemplatePengurangansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('template_pengurangans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('template_pengurangans');
    }
}
