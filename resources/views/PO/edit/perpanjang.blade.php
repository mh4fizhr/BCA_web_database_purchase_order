...
<div class="header bg-primary pb-6">
    ...
    <div class="container-fluid mt--6">
      <section class="content">
        <div class="row">
          <div class="col-12">
            <form action="{{url('/backend/po/perpanjang/proses/'.$po->id)}}" method="post" role="form" id="dynamic_form">
              {{ csrf_field() }}
                <div class="card mb-4">
                  <!-- Card header -->
                    ...
                    <div class="row" id="tambuh">
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-10">
                                <div class="form-group">
                                  <input class="form-control date" type="text" value="{{$po->SelesaiSewa->format('m/d/Y')}}" name="selesaisewa" id="selesaisewa">
                                </div>
                          </div>        
