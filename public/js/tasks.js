$(document).ready(function() {
    $("#btn-add").click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '/backend/cabang/create',
            data: {
                namacabang: $("#frmAddTask input[name=namacabang]").val(),
                kodecabang: $("#frmAddTask input[name=kodecabang]").val(),
                inisialcabang: $("#frmAddTask input[name=inisialcabang]").val(),
                cabangutama: $("#frmAddTask input[name=cabangutama]").val(),
                statuscabang: $("#frmAddTask input[name=statuscabang]").val(),
                kwl: $("#frmAddTask input[name=kwl]").val(),
                kota: $("#frmAddTask input[name=kota]").val(),
            },
            dataType: 'json',
