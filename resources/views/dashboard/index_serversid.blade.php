          ...
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-7 col-7 text-right">
                ...
                <a class="btn btn-secondary" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                  <i class="ni ni-calendar-grid-58"></i>&nbspFilter date : <span class="text-primary">{{$filter_date->kategori}}</span>
                </a>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                      <div class=" table-hover table-responsive mb-3">
                        <table id="myTable" class="table  align-items-center table-flush text-center yajra-datatable">
      ...
      <!--                         <th scope="col"><b>Mulai Sewa</b></th>
                          ...
                          <thead>
                              <tr>
                                  ...
                                  <td></td>
                                  <td></td>
                                  <th><input type="text" class="form-control form-control-sm" placeholder="" disabled style="min-width:100%" /></td>
                                  <th><input type="text" class="form-control form-control-sm" placeholder="" disabled style="min-width:100%" /></td>
                              </tr>
                          </thead>
                          <tbody>
      ...
      $(function () {
        ...
        var table = $('.yajra-datatable').DataTable({
            ...
            columns:[
                ...
                {data:'Sewa', name:'Sewa'},
                {data:'CP', name:'CP'},
                {data:'Mobil_id', name:'mobil.MerekMobil'},
                {data:'Nopol',  name:'Nopol'},
                {data:'Vendor_Driver',  name:'vendor.KodeVendor'},
                {data:'Cabang_id',  name:'cabang.KodeCabang'},
