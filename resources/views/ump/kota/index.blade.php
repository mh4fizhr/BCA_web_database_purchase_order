          ...
          <div class="col-12">
            <div class="card pb-4">
              <div class="card-header border-0">
                <h3 class="mb-0 text-uppercase d-inline-block"><li class="fas fa-map-marker-alt"></li> &nbspDatabase Kota</h3>
                <div class="dropdown float-right">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{url('/backend/ump/kota/active')}}">Active</a>
                    <a class="dropdown-item" href="{{url('/backend/ump/kota/deactive')}}">Deactive</a>
                  </div>
                </div>
              </div>
              
              @if($s == 'active')
                <form action="{{url('/backend/ump/kota/delete_multiple')}}" method="post" role="form">
                    {{ csrf_field() }}
...
<!--                                   <a class="btn btn-primary btn-sm" href="#">
                              ...
                              <td>
                                  ...
                                  <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="customCheck{{$i}}" value="{{$kota->id}}">
