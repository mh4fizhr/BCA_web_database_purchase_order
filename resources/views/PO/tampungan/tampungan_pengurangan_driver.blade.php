        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-header border-0">
              <?php $count_of_po = App\tampungan_pengurangan_driver::all()->count(); ?>
              <div class="row">
                  <div class="col-6">
                  ...
                  <div class="col-6 text-right">
                    @if($count_of_po == 0)
                      <a href="{{url('/backend/po/form_pengurangan_driver_button')}}" class="btn btn-primary btn-round btn-icon disabled">
                        <span class="btn-inner--text">pengurangan</span>
                      </a>
                    @else
                      <a href="{{url('/backend/po/form_pengurangan_driver_button')}}" class="btn btn-primary btn-round btn-icon">
                        <span class="btn-inner--text">pengurangan</span>
                      </a>
                    @endif
                  </div>
                  ...
                  <tbody class="list">
                    ...
                    @foreach($tp_pengurangans as $tp_pengurangan)
                      <tr>
                        ...
                        <td><a class="btn btn-danger btn-sm" href="{{url('/backend/po/pengurangan_driver/tampungan/delete/'.$tp_pengurangan->id)}}"><i class="fas fa-times"></i> &nbspDelete</a></td>
                      </tr>
                      <?php $i++; ?>
                    @endforeach
                    <tr>
