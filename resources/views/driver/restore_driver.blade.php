                        ...
                        <div class="row">
                          ...
                          <div class="col-md-9">
                              <div class="form-group">
                                @foreach($poss as $pos)
                                  @if($po->id == $pos->id)
                                    <input class="form-control date" type="text" value="{{$pos->Nopo_permanent}}" disabled>
                                 @endif
                                @endforeach
                              </div>
                          </div>     
                          ...
                          <div class="col-md-3">
                                <div class="form-group">
                                  <label class="form-control-label ml-3 mt-3" for="example3cols1Input">Driver </label>
                                </div>
                          </div>
                          <div class="col-md-9">
                              <div class="form-group">
                                @foreach($driverss as $drivers)
                                  @if($driver->id == $drivers->id)
                                    <input class="form-control date" type="text" value="{{$drivers->NamaDriver}}" disabled>
                                 @endif
                                @endforeach
                              </div>
                          </div>  
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label class="form-control-label ml-3 mt-3" for="example3cols1Input">Tanggal Mulai </label>
                            </div>
                          </div>
                          <div class="col-md-9">
                            <div class="form-group">
                              <input class="form-control date" type="text" name="mulai" id="mulai" placeholder="mm / dd / yyyy" required>
                            </div>
                          </div>
