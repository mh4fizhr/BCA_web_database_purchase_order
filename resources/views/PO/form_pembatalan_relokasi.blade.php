          ...
          <div class="col-12">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-header">
                    <h3 class="mb-0">Form Pembatalan Relokasi PO</h3>
                  </div>
                  <!-- Card body -->
                  ...
                  <div class="card-body p-5">
                    ...
                    <p>
                        ...
                        @if($po->Sewa == 'Mobil+Driver')
                          <?php $count_driver++; ?>
                          <?php $count_mobil++; ?>
                          <?php $jenis_sewa = 'mobil dan pengemudi' ?>
                        @elseif($po->Sewa == 'Mobil')
                          <?php $count_mobil++; ?>
                          <?php $jenis_sewa = 'mobil' ?>
                        @elseif($po->Sewa == 'Driver')
                          <?php $count_driver++; ?>
                          <?php $jenis_sewa = 'pengemudi' ?>
                        @endif
                    ...
                    <p>
                      ...
                      perihal relokasi {{$jenis_sewa}}, dengan ini kami sampaikan bahwa kami akan melakukan pembatalan relokasi <b>{{$count_mobil}} ({{terbilang($count_mobil)}})</b> unit mobil dan <b>{{$count_driver}} ({{terbilang($count_driver)}})</b> orang driver, dengan data sebagai berikut :
                    </p>
                    <br>
                    ...
                    <table class="table align-items-center table-flush table-hover text-center " id="myTable" style="width: 100%">
                      <thead class="">
                        <tr>
                          ...
                          <th scope="col" colspan="2" class="bg-yellow text-white"><b>Pembebanan ke ...</b></th>              
                        </tr>
                        <tr>
                          <th scope="col" class="bg-yellow text-white"><b>Nama Unit Kerja</b></th>
                      ...
                      <tbody>
                         ...
                         <form action="{{url('/backend/po/update/edit_relokasi/proses')}}" method="post" role="form">
                           ...
                           <tr>
                             ...
                             <td>
                               <input class="form-control" type="text" name="nama_unit_kerja" value="" id="example-date-input" placeholder="" required>
                             </td>

                            <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

                             <td>
                               <input class="form-control" type="text" name="kode_unit_kerja" value="" id="example-date-input" placeholder="" required>
                             </td>
                             <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
