        ...
        <div class="header-body pt-5">
          <div class="row align-items-center pl-4 pb-6">
            <div class="col-lg-6 col-7">
              <div class="dropdown mt-2">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="{{url('/backend/po/salon/'.$tpo->id)}}">All</a>
                  @foreach($ss as $s)
                    @if($s->po_id == $tpo->id)
                      <a class="dropdown-item" href="{{url('/backend/po/salon/filter/'.$tpo->id.'/'.$s->periode)}}">{{$s->periode}}</a>
                    @endif
                  @endforeach
            ...
            <div class="col-lg-6 col-5">
                ...
                <button type="button" class="btn btn-success mt-2 float-right pull-right mr-4" data-toggle="modal" data-target="#salon" data-whatever="@getbootstrap"><i class="fas fa-plus"></i> Add Periode</button>
          ...
          <div class="col-12">
            ...
            <div class="card m-4 pb-3">
              <div class="card-header border-0">
                <h2 class="mb-0 text-uppercase d-inline-block"><li class="fas fa-car"></li> &nbspSalon </h2>
              </div>
                      ...
                      <tbody>
                        <?php $i = 1; ?>
                          ...
                          <tr role="row" class="odd">
                            ...
                            <td>
                              <a class="btn btn-success btn-sm" href="{{url('/backend/po/salon/edit/'.$salon->id)}}">
                                  <i class="fas fa-pencil-alt">
                                  </i>
                                  
                              </a>
                              <a class="btn btn-danger btn-sm" href="{{url('/backend/report/salon/delete/'.$salon->id)}}">
