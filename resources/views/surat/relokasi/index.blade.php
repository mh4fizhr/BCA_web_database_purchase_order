          ...
          <div class="col-12">
            <div class="card pb-4">
              <div class="card-header border-0">
                <h3 class="mb-0 text-uppercase d-inline-block"><li class="fas fa-file-word nav-icon"></li> &nbspDatabase Surat relokasi</h3>
                <!-- <div class="dropdown float-right">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{url('/backend/surat/relokasi/status/active')}}">not approved</a>
                    <a class="dropdown-item" href="{{url('/backend/surat/relokasi/status/deactive')}}">approved</a>
                  </div>
                </div> -->
              </div>
              
              @if($s == 'active')
                 <form action="{{url('/backend/surat/relokasi/status')}}" method="post" role="form">
                    {{ csrf_field() }}
                    ...
                    <table class="table align-items-center table-flush table-hover text-center mydatatable" id="myTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            @if($template_relokasi->status == '1' || $template_relokasi->status == '2')
                          ...
                          <!-- <td>
                            ...
                            @else
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="status[]" id="customCheck{{$i}}" value="{{$template_relokasi->id}}">
             ...
             @endif
                <!-- <div class="table-responsive">
                    ...
                    <form action="{{url('/backend/surat/relokasi/delete_multiple')}}" method="post" role="form">
                    {{ csrf_field() }}
                    <table class="table align-items-center table-flush table-hover text-center mydatatable" id="myTable">
                      <thead class="thead-light" style="height: 70px">
                        <tr>
