...
<div class="header bg-primary pb-6">
    ...
    <div class="container-fluid mt--6">
      <section class="content">
        <div class="row">
          <div class="col-12">
            <form action="{{url('/backend/po/service/edit/proses/'.$service->id)}}" method="post" role="form" id="dynamic_form">
              {{ csrf_field() }}
                <div class="card mb-4">
                  <!-- Card header -->
                  <div class="card-header">
                    <h3 class="mb-0">Form edit {{$page}}</h3>
                  </div>
                  <!-- Card body -->
                  <div class="card-body">
                    ...
                    <div class="row" id="tambuh">
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-10">
                                <div class="form-group">
                                  <!-- <input class="form-control date" type="text" name="tgl_service" id="tgl_service" placeholder="mm / dd / yyyy" value="{{$service->TglService}}"> -->
                                  <input class="form-control date" type="text" name="tgl_service" id="tgl_service" value="{{$service->TglService}}" placeholder="mm / dd / yyyy">
                                </div>
                          </div>                       
                          ...
                          <div class="col-md-10">
                                <div class="form-group">
                                  <input type="text" class="form-control" id="km" value="{{$service->km}}">
                                  <input type="hidden" name="km" class="form-control" id="km_hidden" value="{{$service->km}}">
                                </div>
                          </div>  
                          ...
                          <div class="col-md-10">
                                <div class="form-group">
                                  <textarea class="form-control" name="keterangan" id="exampleFormControlTextarea1" rows="3" >{{$service->Keterangan}}</textarea>
                                </div>
                          </div>  
