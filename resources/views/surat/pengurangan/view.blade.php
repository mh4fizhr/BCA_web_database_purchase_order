...
<div class="header bg-primary pb-6">
          ...
          <div class="col-12">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body p-5">
                    ...
                    <p>
                      <span>No. {{$template_pengurangan->no_surat}}</span>
                      
                      <!-- <span class="float-right">{{$template_pengurangan->tgl_surat}}</span> -->
                      <span class="float-right">{{$template_pengurangan->tgl_surat}}</span>
                    </p>
                    <br>
                    <p>
                    ...
                    <p>
                      <b>Up. Yth. </b><b>{{$vendor_pejabat}} – {{$template_pengurangan->jabatan_vendor}}</b>
                      <!-- <input type="text" class="form-control form-control-sm" list="team_list" id="jabatan_vendor" value="{{$template_pengurangan->jabatan_vendor}}" placeholder="Jabatan" required autocomplete="off" style="width: 150px;display: inline;"> -->
                    ...
                    <p>
                      ...
                      Menunjuk {{$template_pengurangan->pks}}
                      
                      No. {{$template_pengurangan->no_pks}}
                      
                      tanggal {{$template_pengurangan->tgl_pks}} 
                      
                      , dengan ini kami sampaikan penghentian sewa mobil sebanyak <b><span id="count_mobil">{{$template_pengurangan->jml_mobil}} ({{terbilang($template_pengurangan->jml_mobil)}})</span></b> unit dan pengemudi sebanyak <b><span id="count_driver">{{$template_pengurangan->jml_driver}} ({{terbilang($template_pengurangan->jml_driver)}})</span></b> orang, dengan data sebagai berikut :
                    </p>
                    <br>
                    ...
                    <table class="table align-items-center table-flush table-hover text-center " id="myTable" style="width: 100%">
                      ...
                      <tbody>
                         ...
                         <form action="{{url('/backend/po/update/edit_pengurangan/proses')}}" method="post" role="form">
                           ...
                           <input type="hidden"                           name="sewa" value="Driver">
                           ...
                           <tr>
                             ...
                             <td>
                               {{$table_template_pengurangan->nama_cabang}}
                             </td>

                             <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->

                             <td>
                               {{$table_template_pengurangan->kode_cabang}}
                             </td>
                             ...
                             <td>
                               ...
                               @foreach($mobils as $mobil)
                                 @if($table_template_pengurangan->merek == $mobil->id)
                             ...
                             <td>
                               {{$table_template_pengurangan->nopol}}
                             </td>
                             ...
                             <td>
                               ...
                               {{ strftime('%d %B %Y', strtotime($table_template_pengurangan->tgl_efektif))}}
                             </td>
                             ...
                             <td>
                               ...
                               @if($table_template_pengurangan->keterangan == "Mobil+Driver")
                                 <span value="Mobil+Driver">Mobil dan Pengemudi</span>
                               @elseif($table_template_pengurangan->keterangan == "Driver")
                                 <span value="Driver">Pengemudi</span>
                               @elseif($table_template_pengurangan->keterangan == "Mobil")
                                 <span value="Mobil">Mobil</span>
                               @endif
                           </tr>
 ...
 -->
                      ...
                      @if($template_pengurangan->unitkerja_pb1 == $template_pengurangan->unitkerja_pb2)
                        <span id="unitkerja_pb1">{{$template_pengurangan->unitkerja_pb1}}</span>
                      @else
