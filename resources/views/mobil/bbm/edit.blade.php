...
<div class="header bg-primary pb-6">
    ...
    <div class="container-fluid mt--6">
      <section class="content">
        <div class="row">
          <div class="col-12">
            <form action="{{url('/backend/bbm/edit/proses/'.$bbm->id)}}" method="post" role="form" id="dynamic_form">
              {{ csrf_field() }}
                <div class="card mb-4">
                  <!-- Card header -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="jenis_bbm" id="bbm" class="form-control" value="{{$bbm->jenis_bbm}}" id="exampleInputtext1" required>
                                  <span id="error_bbm"></span>
                                </div>
                          </div>                       
