...
<div class="header bg-primary pb-6">
          ...
          <div class="col-12">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body p-5">
                    <p>
                      <span>No. {{$template_relokasi->no_surat}}</span> 
                      ...
                      <tbody>
                         ...
                         <form action="{{url('/backend/po/update/edit_relokasi/proses')}}" method="post" role="form">
                           ...
                           <tr>
                             ...
                             <td>
                               @if(!isset($table_template_relokasi->merek))
                               ...
                               @foreach($mobils as $mobil)
                                 @if($table_template_relokasi->merek == $mobil->id)
                               ...
                               @if($table_template_relokasi->sewa != 'null')
                             ...
                             <td>
                               ...
                               @elseif($table_template_relokasi->sewa == 'Mobil')
                                  <span class="">Mobil</span> 
                               @elseif($table_template_relokasi->sewa == 'Driver')
                             ...
                             <td>
                                 ...
                                 <span class="">{{$table_template_relokasi->status_cabang_lama}} {{$table_template_relokasi->nama_cabang_lama}}</span>
                             ...
                             <td>
                                 ...
                                 <span class="">{{$table_template_relokasi->kode_cabang_lama}}</span>
                             ...
                             <td>
                                 ...
                                 <!-- @foreach($cabangs as $cabang)
                                   @if($cabang->id == $po->Cabang_relokasi)
                                     <span class="">{{$cabang->KWL}} - {{$cabang->KodeCabang}} - {{$cabang->NamaCabang}} - {{$cabang->Kota}}</span> 
                                   @endif
                                 @endforeach -->

                                 <span class="">{{$table_template_relokasi->status_cabang_baru}} {{$table_template_relokasi->nama_cabang_baru}} - {{$table_template_relokasi->kode_cabang_lama}}</span>
 ...
 -->
                             ...
                             <td>
                              {{ strftime('%d %B %Y', strtotime($table_template_relokasi->tgl_efektif))}}
                    ...
                    <p>
                      ...
                      @if($template_relokasi->unitkerja_pb1 == $template_relokasi->unitkerja_pb2)
                        <span id="unitkerja_pb1">{{$template_relokasi->unitkerja_pb1}}</span>
                      @else
