            ...
            <div class="card pb-4">
              <div class="card-header border-0">
                ...
                <div class="table-responsive">
                    <form action="{{url('/backend/admin/vendor/delete')}}" method="post" role="form">
                    {{ csrf_field() }}
                    <!-- Projects table -->
                      ...
                      <tbody>
                        <?php 
                          ...
                          @endif
                            ...
                            <td>
                                <div class="custom-control custom-checkbox">
                                  <input type="checkbox" class="custom-control-input" name="vendor[]" id="customCheck{{$i}}" value="{{$vendor->id}}">
