          ...
          <div class="col-12">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body p-5">
                    ...
                    <p>
                      <b>Perihal : Perubahan Data Pairing</b>
                    ...
                    <p>
                      ...
                      , dengan ini kami sampaikan perubahan data pairing sebanyak <b>{{count($poss)}} ({{terbilang(count($poss))}})</b> unit, dengan data sebagai berikut :
                    </p>
                    <br>
                    ...
                    <table class="table align-items-center table-flush table-hover text-center " id="myTable" style="width: 100%">
                      ...
                      <tbody>
                         ...
                         @foreach($poss as $po)
                         <?php $i++; ?>
                         <form action="{{url('/backend/po/edit_perubahan/multiple/'.$po->id)}}" method="post" role="form">
                           {{ csrf_field() }}
                           ...
                           <!-- <input type="hidden" id="sewa_hasil{{$i}}"     name="sewa[]" value="{{$po->Sewa_sementara}}"> -->
                           ...
                           <tr>
                             ...
                             <td>
                               <input class="form-control date" type="text" placeholder="mm / dd / yyyy" name="tgl_efektif[]" id="example-date-input" autocomplete="off" required>
                             </td>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="form-group float-right pull-right">
                        <a href="{{url('backend/po/perubahan')}}" type="button" class="btn btn-default">Back</a>
