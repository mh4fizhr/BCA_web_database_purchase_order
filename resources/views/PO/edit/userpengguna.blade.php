...
<div class="header bg-primary pb-6">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h1 class=" text-white d-inline-block mb-0">User pengguna</h1>
    ...
    <div class="container-fluid mt--6">
      <section class="content">
        <div class="row">
          <div class="col-12">
            <form action="{{url('/backend/po/userpengguna/edit/proses')}}" method="post" role="form" id="dynamic_form">
              {{ csrf_field() }}
                <div class="card mb-4">
                  <!-- Card header -->
                  <div class="card-header">
                    <h3 class="mb-0">Form edit user pengguna</h3>
                  </div>
                  <!-- Card body -->
                  <div class="card-body">
                    ...
                    <div class="row" id="tambuh">
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-10">
                                <div class="form-group">
                                  <input class="form-control" type="text" name="userpengguna" id="userpengguna" value="{{$po->UserPengguna}}">
                                </div>
                          </div>                       
