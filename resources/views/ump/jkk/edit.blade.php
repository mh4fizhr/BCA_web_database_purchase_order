...
<div class="header bg-primary pb-6">
    ...
    <div class="container-fluid mt--6">
      <section class="content">
        <div class="row">
          <div class="col-12">
            <form action="{{url('/backend/ump/jkk/edit/proses/'.$jkk->id)}}" method="post" role="form" id="dynamic_form">
              {{ csrf_field() }}
                <div class="card mb-4">
                  <!-- Card header -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="jkk" id="jkk" class="form-control" value="{{$jkk->jkk}}" id="exampleInputtext1" required>
                                  <span id="error_jkk"></span>
                                </div>
                          </div>                       
...
//          if(result == 'unique')
//          {
//             $('#error_jkk').html('<label class="text-success">*jkk belum tersedia</label>');
//             $('#jkk').removeClass('has-error');
//             $('#submit').attr('disabled', false);
//          }
//          else
//          {
//             $('#error_jkk').html('<label class="text-danger">*jkk sudah ada</label>');
//             $('#jkk').addClass('has-error');
//             $('#submit').attr('disabled', 'disabled');
//          }
//       }
//    })
